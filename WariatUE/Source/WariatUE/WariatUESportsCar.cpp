...
#include "WariatUESportsCar.h"
#include "WariatUESportsWheelFront.h"
#include "WariatUESportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AWariatUESportsCar::AWariatUESportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UWariatUESportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UWariatUESportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UWariatUESportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UWariatUESportsWheelRear::StaticClass();
