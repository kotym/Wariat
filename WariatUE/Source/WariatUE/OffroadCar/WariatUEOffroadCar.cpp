...
#include "WariatUEOffroadCar.h"
#include "WariatUEOffroadWheelFront.h"
#include "WariatUEOffroadWheelRear.h"
...
AWariatUEOffroadCar::AWariatUEOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UWariatUEOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UWariatUEOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UWariatUEOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UWariatUEOffroadWheelRear::StaticClass();
